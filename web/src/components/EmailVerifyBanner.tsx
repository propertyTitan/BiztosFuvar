...
//
// Helye: minden bejelentkezett oldal teteje (root layout-ban beemelni).
...
export default function EmailVerifyBanner() {
  ...
  useEffect(() => {
    let cancelled = false;
    // A token nélküli oldalak nem mutatják a bannert (homepage-en
    // pl. nincs is bejelentkezett user)
