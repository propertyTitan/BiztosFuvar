...
//
// MVP-szinten egyszerű „accept all" / „decline" choice. Ha későbbi
// fázisban analytics / marketing süti is bekerül, kategorizálni kell
// (necessary / analytics / marketing) és granular consent-et kérni.
...
export default function CookieConsentBanner() {
  ...
  function decide(choice: Choice) {
    ...
    setShow(false);
    // Custom event hogy más komponensek (pl. analytics loader) tudjanak
    // reagálni, ha későbbi sprintben kell.
