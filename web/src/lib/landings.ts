...
const USECASES: LandingConfig[] = [
  ...
  },
  {
    ...
    metaDescription: 'Albérlet-váltás, néhány bútor és doboz? Vidd el egy sofőrrel, aki úgyis arra megy. Gyakran olcsóbb, mint egy költöztető cég, fotó + 6 jegyű átvételi kód.',
    eyebrow: 'Költöztetés',
    headline: 'Költözöl? Nem kell hozzá teljes költöztető cég',
    subhead: 'Egy albérlet-váltás, pár bútor és néhány doboz — a GoFuvar sofőrök elviszik, gyakran olcsóbban és rugalmasabban, mint egy dedikált költöztető. Te szabod meg a díjat a feladásnál.',
    ...
    faq: [
      { q: 'Mennyibe kerül egy kis költözés?', a: 'A fuvardíjat te szabod meg feladáskor (az okos árazó ad egy sávot a távolság, súly és méret alapján), a sofőrök arra tesznek ajánlatot. A GoFuvar egy sávos kapcsolatfelvételi díjat számít az elfogadáskor.' },
  ...
  },
  {
    ...
    metaDescription: 'Mosógép, hűtő, mosogatógép, szárítógép elvitele egy sofőrrel furgonnal. Gyakran olcsóbb, mint a bolti kiszállítás, fotó + 6 jegyű átvételi kód.',
    eyebrow: 'Nagygép-szállítás',
    headline: 'Mosógép, hűtő? Van rá sofőr furgonnal',
    subhead: 'Nagy háztartási gép, ami nem fér a kocsidba? Egy GoFuvar sofőr furgonnal elviszi — gyakran olcsóbban, mint a bolti kiszállítás. Te szabod meg a díjat.',
    ...
    bullets: [
      ...
      { icon: '💵', title: 'Te szabod az árat', desc: 'A feladásnál te adod meg a díjat, a sofőrök arra licitálnak.' },
    ],
    faq: [
  ...
  },
  {
    ...
    metaDescription: 'Vettél valamit Jófogáson vagy Facebook Marketplace-en, de nincs mivel elhozni? Egy sofőr elhozza neked. Fotó + 6 jegyű kód, gyakran olcsóbb, mint egy futár.',
  ...
  },
  {
    ...
    bullets: [
      ...
      { icon: '💵', title: 'Te szabod az árat', desc: 'A feladásnál te adod meg a díjat, a szállítók arra licitálnak.' },
    ],
    faq: [
