...
const USECASES: LandingConfig[] = [
  {
    ...
    subhead: 'Egy kanapé, egy szekrény, egy marketplace-en vett asztal — a GoFuvar sofőrök elviszik, gyakran olcsóbban, mint egy dedikált költöztető. A sofőrök ajánlatot tesznek rá, te a neked megfelelőt választod.',
  ...
  },
  {
    ...
    subhead: 'Egy albérlet-váltás, pár bútor és néhány doboz — a GoFuvar sofőrök elviszik, gyakran olcsóbban és rugalmasabban, mint egy dedikált költöztető. A sofőrök ajánlatot tesznek rá, te a neked megfelelőt választod.',
  ...
  },
  {
    ...
    subhead: 'Nagy háztartási gép, ami nem fér a kocsidba? Egy GoFuvar sofőr furgonnal elviszi — gyakran olcsóbban, mint a bolti kiszállítás. A sofőrök licitálnak rá, te a neked megfelelőt fogadod el.',
