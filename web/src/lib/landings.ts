...
const PERSONAS: LandingConfig[] = [
  {
    ...
    metaDescription: 'Úgyis mész A-ból B-be — autóval, biciklivel, gyalog vagy tömegközlekedéssel? Vállalj fuvart az útvonaladon. A fuvardíj készpénzben a tiéd, te választod a fuvart.',
    eyebrow: 'Sofőröknek',
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'Kell azonosítás?', a: 'Igen: személyazonosság-ellenőrzés (személyi igazolvány) szükséges. Sofőrként ezen felül egy rövid nyilatkozatot fogadsz el (jogszabályok + KRESZ betartása).' },
    ],
  },
];
