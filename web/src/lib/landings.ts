...
function routeConfig(r: { slug: string; from: string; to: string; km: number }): LandingConfig {
  ...
  return {
    ...
    kind: 'route',
    navLabel: title,
    metaTitle: `Fuvar ${title} — csomagküldés és költöztetés`,
    metaDescription: `Küldj csomagot vagy bútort ${title} útvonalon megbízható szállítókkal. Fotó + 6 jegyű átvételi kód, a fuvardíj közvetlenül a szállítóé, KYC-ellenőrzött szállítók. Add fel pár perc alatt.`,
    eyebrow: 'Útvonal',
    ...
    bullets: [
      ...
      { icon: Banknote, tint: 'var(--success)', title: 'A fuvardíj közvetlenül a szállítóé', desc: 'A fuvardíjat közvetlenül a szállítónak fizeted — készpénzben vagy átutalással, ahogy megegyeztek; a GoFuvar csak egy kis kapcsolatfelvételi díjat szed elfogadáskor.' },
    ],
    faq: [
...
const PERSONAS: LandingConfig[] = [
  {
    ...
    metaDescription: 'Sofőr, futár vagy fuvarozó vagy — vagy csak úgyis mész A-ból B-be? Vállalj fuvart az útvonaladon szállítóként. A fuvardíj 100%-a a tiéd, te választod a fuvart.',
    ...
    bullets: [
      ...
      { icon: Banknote, tint: 'var(--success)', title: 'A fuvardíj 100%-a a tiéd', desc: 'A fuvardíjat közvetlenül a feladótól kapod — készpénzben vagy átutalással, ahogy megegyeztek —, levonás nélkül: a GoFuvar a fuvardíjhoz nem nyúl.' },
    ],
    faq: [
      { q: 'Kell hozzá vállalkozás?', a: 'A saját adóügyi státuszodért te felelsz (rendszeres kereső tevékenységhez a magyar jog szerint általában vállalkozói forma kell). A GoFuvar a fuvardíjat nem kezeli és nem számlázza — az a te és a feladó közti közvetlen ügylet (készpénz vagy átutalás, ahogy megegyeztek).' },
  ...
  },
  {
    ...
    metaTitle: 'Rugalmas kiszállítás webshopoknak és marketplace-eladóknak',
  ...
  },
  {
    ...
    metaTitle: 'Fuvarozó cégeknek és egyéni vállalkozóknak — rendszeres fuvar jutalék nélkül',
    metaDescription: 'Fuvarozó vállalkozás vagy egyéni vállalkozó? Töltsd meg az üres visszautaidat, kapj rendszeres fuvarokat az útvonaladon, és tartsd meg a fuvardíj 100%-át — a platform nem von le jutalékot a díjadból.',
    eyebrow: 'Fuvarozó vállalkozásoknak',
    headline: 'Rendszeres fuvar a vállalkozásodnak — jutalék nélkül',
    subhead: 'Fuvarozó cég, egyéni vállalkozó vagy hivatásos szállító? Töltsd meg az üres kilométereidet és a visszautaidat rendszeres fuvarokkal. A fuvardíj 100%-a a tiéd — készpénzben vagy átutalással, ahogy megegyeztek; a GoFuvar a te díjadból NEM von le jutalékot.',
    primaryCta: { label: 'Regisztrálj fuvarozóként', href: '/bejelentkezes?mode=register' },
    bullets: [
      { icon: HandCoins, tint: 'var(--success)', title: 'A fuvardíj 100%-a a tiéd', desc: 'A díjat közvetlenül a feladótól kapod — készpénzben vagy átutalással —, a platform NEM von le belőle jutalékot. A GoFuvar bevétele a feladótól szedett kapcsolatfelvételi díj — a te díjadhoz nem nyúlunk.' },
    ...
    faq: [
      { q: 'Mennyit von le a platform a fuvardíjból?', a: 'Semmit. A fuvardíj 100%-a a tiéd, közvetlenül a feladótól (készpénzben vagy átutalással, ahogy megegyeztek). A GoFuvar bevétele a feladótól szedett kapcsolatfelvételi díj — a te díjadhoz nem nyúlunk.' },
...
const USECASES: LandingConfig[] = [
  {
    ...
    metaTitle: 'Bútorszállítás olcsón és biztonságosan',
  ...
  },
  {
    ...
    metaTitle: 'IKEA, OBI, Praktiker behozatal — hozasd el a vásárlásod',
  ...
  },
  {
    ...
    metaTitle: 'Költöztetés olcsón — kis költözés szállítóval',
  ...
  },
  {
    ...
    metaTitle: 'Mosógép, hűtő szállítás — nagygép elvitele',
  ...
  },
  {
    ...
    metaTitle: 'Jófogás, Marketplace vásárlás elhozása',
  ...
  },
  {
    ...
    metaTitle: 'Autószállítás trélerrel — autó elvitele A-ból B-be',
