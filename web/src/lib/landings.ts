...
const PERSONAS: LandingConfig[] = [
  {
    ...
    metaDescription: 'Úgyis mész A-ból B-be — autóval, biciklivel, gyalog vagy tömegközlekedéssel? Vállalj fuvart az útvonaladon. Jogosítvány NEM kell, a fuvardíj készpénzben a tiéd, te választod a fuvart.',
    eyebrow: 'Sofőröknek',
    headline: 'Az utaidat pénzzé teszed — bármivel',
    subhead: 'Ha úgyis mész valahová — autóval, biciklivel, gyalog vagy tömegközlekedéssel —, vigyél magaddal egy csomagot az útvonaladon. Jogosítvány nem kell, csak a személyi igazolvány. Te döntöd el, melyik fuvart vállalod.',
    primaryCta: { label: 'Regisztrálj sofőrként', href: '/bejelentkezes?mode=register' },
    bullets: [
      { icon: '🚲', title: 'Bármivel szállíthatsz', desc: 'Autó, furgon, bicikli, gyalog vagy tömegközlekedés — mind mehet. Jogosítvány nem kell, csak a személyi igazolvány igazolása.' },
