...
// A user új jelszót ad meg → backend megnézi a token-hash-t →
// frissíti a password_hash-t → token törlődik (egyszer használatos).
...
function JelszoResetInner() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setDone(true);
      // 2 másodperc után átirányítjuk a login-ra
