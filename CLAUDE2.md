# CLAUDE2.md — GoFuvar történeti melléklet (a CLAUDE.md folytatása)

> ⚠️ **Ez a fájl NEM töltődik be automatikusan** — szándékosan. 2026-09-17-én
> a `CLAUDE.md` 258 KB volt (a Claude Code 150 KB fölött figyelmeztet), ezért
> a LEZÁRT körök teljes, változatlan naplója ide került. Az ÉLŐ szabályok,
> az üzleti döntések, a launch-teendők és a tanulságok DIGESTJE a
> `CLAUDE.md`-ben maradtak (6. szakasz, „✅ Kész (élesedett) — összefoglaló").
>
> **Mikor olvasd:** ha egy régi javítás/döntés RÉSZLETE kell — melyik PR,
> melyik őr-teszt, mi volt a gyökérok, mit mért az ügynök, mi volt a saját
> hiba. Keresés: `grep -n "<kulcsszó>" CLAUDE2.md` (pl. `GF-008`,
> `SEC-003`, `PR #176`, `retencio`).
>
> **Karbantartás:** új tétel a `CLAUDE.md` ✅ összefoglalójának tetejére megy
> röviden; ha a CLAUDE.md 120 KB fölé nő, a legrégebbi lezárt köröket
> VÁLTOZATLAN szöveggel ide kell átmozgatni (a megfelelő rész végére,
> időrend: legújabb felül). Itt semmit nem írunk át utólag — ez napló.

## Tartalom

1. ✅ Lezárva — fizetési szöveg-elcsúszás (2026-08-18, PR #186)
2. 🔐 Manus biztonsági audit (2026-08-31) — 9 megállapítás, EREDETI LISTA
   (a feldolgozás összefoglalója a CLAUDE.md-ben maradt)
3. 🆕 Manus P1 célzott regresszió, 3. futás — feldolgozás (4. javítási kör)
   + EREDETI LISTA
4. 🔄 Manus regressziós újrateszt, 2. futás — feldolgozás (3. javítási kör)
   + EREDETI LISTA (24 tétel külső verdiktje)
5. 🐞 Manus-jelentés (2026-08-30) — a 24 tétel teljes hibajegyzéke
6. ✅ Kész (élesedett) — TELJES TÉTELES NAPLÓ, 2026-07 → 2026-09-11
   (legújabb felül; ~1700 sor)
...
### ✅ Kész (élesedett) — TELJES TÉTELES NAPLÓ (2026-07 → 2026-09-11, legújabb felül)
