...
//
// Az email link megnyitása a mobil böngészőben fog történni (a webes
// /email-megerositese oldal handle-eli). Universal link / app link
// bekötés egy későbbi sprintben.
