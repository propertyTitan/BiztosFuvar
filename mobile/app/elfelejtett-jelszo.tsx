// Elfelejtett jelszó űrlap mobilon.
//
// A tényleges reset a webes /jelszo-reset oldalon történik (a user a
// kapott emailben oda kattint). Itt csak az email cím megadása + a
// "küldtünk neked emailt" megerősítés.
//
// Universal link / deep link bekötés későbbi sprintben jön — addig
// a webes URL nyilik meg, ami működik telefonon böngészőben is.
