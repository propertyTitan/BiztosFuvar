...
const RETENTION_MANIFEST = {
  ...
  bids:                { szabaly: 'a SOR törlődik, amikor a fuvar anonimizálódik (anonymizeOldJobs) — nem csak a message ürül' },
  job_questions:       { szabaly: 'a SOR törlődik, amikor a fuvar anonimizálódik (anonymizeOldJobs) — nem csak a szöveg ürül' },
